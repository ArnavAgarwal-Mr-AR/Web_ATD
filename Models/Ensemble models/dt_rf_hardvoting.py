#Combining DecisionTree Normal and RandomForest Normal by HARD Voting Method of Ensemble Learning
...
voting_classifier = VotingClassifier(estimators=[
    ('DecisionTree_Normal', decision_tree_model),
    ('RandomForest_Normal', random_forest_model)
], voting='hard')
...
training_time = stop_timer("ENS_VOTING_DT_RF_normal")
...
save_accuracies("ENS_VOTING_DT_RF_normal", training_accuracy, validation_accuracy, testing_accuracy, training_classification_rep, validation_classification_rep, testing_classification_rep)
