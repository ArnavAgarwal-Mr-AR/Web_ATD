...
grid_search_dt = GridSearchCV(estimator=decision_tree_model, param_grid=param_grid_dt, cv=5, scoring='accuracy')
...
training_time = stop_timer("DecisionTree_Gridsearched")
...
save_accuracies("DecisionTree_Gridsearched", training_accuracy, validation_accuracy, testing_accuracy, training_classification_rep, validation_classification_rep, testing_classification_rep)
