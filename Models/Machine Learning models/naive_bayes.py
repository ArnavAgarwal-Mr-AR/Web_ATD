...
# Train a Naive Bayes model (Gaussian Naive Bayes)
...
training_time = stop_timer("NaiveBayes_Normal")

# Predict on training, validation, and testing sets
y_train_pred = naive_bayes_model.predict(X_train_scaled)
y_val_pred = naive_bayes_model.predict(X_val_scaled)
y_test_pred = naive_bayes_model.predict(X_test_scaled)
...
save_accuracies("NaiveBayes_Normal", training_accuracy, validation_accuracy, testing_accuracy, training_classification_rep, validation_classification_rep, testing_classification_rep)
