...
training_time = stop_timer("LogisticReg_Normal")

# Predict on training, validation, and testing sets
y_train_pred = logistic_reg_model.predict(X_train_scaled)
y_val_pred = logistic_reg_model.predict(X_val_scaled)
y_test_pred = logistic_reg_model.predict(X_test_scaled)
...
save_accuracies("LogisticReg_Normal", training_accuracy, validation_accuracy, testing_accuracy, training_classification_rep, validation_classification_rep, testing_classification_rep)
