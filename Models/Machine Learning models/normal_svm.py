...
training_time = stop_timer("SVM_Normal")
...
save_accuracies("SVM_Normal", training_accuracy, validation_accuracy, testing_accuracy, training_classification_rep, validation_classification_rep, testing_classification_rep)
